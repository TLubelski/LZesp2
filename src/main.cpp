...
int main(int argc, char **argv)
{
  ...
  {
    cerr << "[!]Blad: Podaj trudnosc: latwy/trudny" << endl;
    return 1;
  }
  ...
  //INFO
  cout << endl << "---- Start testu arytmetyki zespolonej ----" << endl;
  ...
  while ( !Plik_We.eof() ) {        // Do konca pliku pobieraj pytania
    Plik_We >> WyrZ_PytanieTestowe; 
    
    cout << endl << "-- Pytanie " << getWsz(Statyskyka)+1 <<  " --" << endl;  //wysw pytania
  ...
  cout << endl << " Koniec testu" << endl; //zakonczenie testu i wysw statystyk
  cout << endl << Statyskyka << endl; 
